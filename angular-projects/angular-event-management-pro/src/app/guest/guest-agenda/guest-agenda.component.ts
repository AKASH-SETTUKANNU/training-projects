...
@Component({
  selector: 'app-guest-agenda',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './guest-agenda.component.html',
  styleUrl: './guest-agenda.component.css'
})
export class GuestAgendaComponent  implements OnInit {
  events: Event[] = [];
